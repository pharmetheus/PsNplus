\makeatletter
\def\input@path{{/PMX/Projects/Pharmetheus/PMX-RRW-PMX-2/encore/LaTeX/}}
\makeatother
\documentclass[hideglossary,notoc,hidelof,hidelot,hideTheSignaturePage,hideLinkCurrent,hideloa,pdfLatex,noClient,notitle]{PMXstyle-20170118kajsa4}
...
\documenttype{Software Specification}
\projecttitle{scmplus}
\shortprojecttitle{scmplus} 
\documentreference{scmplus}
...
\input{/home/kajsa/kod-psn/PsN4/doc/inputs/basic_options.tex}
